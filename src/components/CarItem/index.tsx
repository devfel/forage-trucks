// forage-trucks/src/components/CarItem/index.tsx
...
const CarItem: React.FunctionComponent<Vehicle> = ({ id, avatar, periodSelected, bio, name, stringDate, nameSelected }) => {
  ...
  function checkValidPeriod(period: string): boolean {
    ...
    if ((period.split(" to ")[0].split(" ")[0].split(":")[0] === "12" && period.split(" to ")[0].split(" ")[1] === "AM") || (period.split(" to ")[1].split(" ")[0].split(":")[0] === "12" && period.split(" to ")[1].split(" ")[1] === "AM")) {
      return false;
    }
